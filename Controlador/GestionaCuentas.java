...
public class GestionaCuentas {
	...
	CuentaBancaria c1 = new CuentaBancaria (200, 15478965, LocalDate.of(2025, 01, 10),t1);
	CuentaBancaria c2 = new CuentaBancaria (400, 47887596, LocalDate.of(2025, 01, 11),t2);
	CuentaBancaria c3 = new CuentaBancaria (600, 78965423, LocalDate.of(2025, 01, 12),t3);
